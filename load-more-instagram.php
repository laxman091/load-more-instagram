...
add_action( 'admin_menu', 'my_admin_menu_load_more' );

function my_admin_menu_load_more() {
...
<div class="col-sm-4 profile_img">
	...
	<div class="row">
	<div class="col-sm-4" style="border-style: solid;"><img src="<?php echo get_option('myinstagram_image'); ?>" onclick="window.open(this.src);"></div>
	</div>

	<div class="row">
    <div class="col-sm-4" style=""><?php echo get_option('myinstagram_fullname'); ?></div>
    </div> <!-- row -->
    ...
    <div class="row">
    <div class="col-sm-10" style=""><p>Use this shortcode <span id="hightlight">[myinstagram_load_images]</span> to show instagram posts.</p>
    </div>	<!--  column -->
    </div>
    </div>
...
//$(document).ready(function() {
  $(function(){
    ...
    var request_uri = 'https://api.instagram.com/oauth/authorize/?client_id=fbda7e48f09e4b98822e9df40ee40dfe&redirect_uri=localhost/wordpress/wp-admin/admin.php?page=myinstagram&response_type=token';
